...
const TERMS_OF_USE = [
  ...
  'You must not use the App to collect any personal information or personal health information about any individual. Such information includes photos, videos, screen captures and screen recordings of the individual’s QR code.',
  'You must not use the App to submit false or inaccurate information.',
