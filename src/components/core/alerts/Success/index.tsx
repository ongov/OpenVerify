...
export const VerifiedSubContainer = styled(SubContainer)`
  background-color: ${({theme}) => theme.colors.successLightGreen};
  margin-bottom: ${({theme}) => theme.variables.spacing.md}px;
  margin-top: ${({theme}) => theme.variables.spacing.lg}px;
`;

export const VerifiedStripeView = styled(StripeView)`
...
const SuccessPageAlert: FC<Props> = ({children, title, style}) => (
  <VerifiedSubContainer style={style}>
    <VerifiedStripeView />
    <TitleView>
